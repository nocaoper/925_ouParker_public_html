/*!
 * The code get userInfo came from FancyTrack
...
window.onerror = function (errorMsg, url, lineNumber, column, errorObj) {
  console.log('My Error: ' + errorMsg + ' Script: ' + url + ' Line: ' + lineNumber
      + ' Column: ' + column + ' StackTrace: ' +  errorObj);

  var dat = new Date().format("yyyy-MM-dd hh:mm:ss tt");
    getUserInfo();
    let refErr = db.ref('err/errors');
    let stk = {
      errorMsg: errorMsg,
      url: url,
    ...
    let toPush = Object.assign({}, stk, me);
    refErr.push(toPush);
}
